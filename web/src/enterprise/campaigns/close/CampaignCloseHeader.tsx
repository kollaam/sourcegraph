...
const CampaignCloseHeader: React.FunctionComponent<CampaignCloseHeaderProps> = () => (
    <>
        ...
        <h5 className="d-none d-sm-block text-uppercase text-center text-nowrap">Check state</h5>
        <h5 className="d-none d-sm-block text-uppercase text-center text-nowrap">Review state</h5>
